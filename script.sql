...
ALTER TABLE ONLY public.tb_product_category
    ADD CONSTRAINT tb_product_category_pkey PRIMARY KEY (product_id, caterogy_id);
...
--
-- Name: tb_product_category fk40pl28rotl6ka1v5oey5sa37a; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_product_category
    ADD CONSTRAINT fk40pl28rotl6ka1v5oey5sa37a FOREIGN KEY (caterogy_id) REFERENCES public.tb_category(id);
...
\unrestrict JRHYkj6mu8UJDnomdBhMwwnPDiJbjcT6RXhmnj20R6kKR8saw8iEKU6kncIB1Kp
